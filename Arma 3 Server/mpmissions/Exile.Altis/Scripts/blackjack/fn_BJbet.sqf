...
disableSerialization; 
 ...
 if(ExileClientPlayerMoney < _betamt) exitWith {
	hint format["You don't have enough money to play (%1$)",_betamt]; 
 }; 
 _newPoptabs = ExileClientPlayerMoney - _betamt;
 ...
 // give dealer 1 card, other is XX // give player 2 cards
